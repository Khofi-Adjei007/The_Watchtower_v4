...
urlpatterns = [
    ...
    path('CaseStep1Form/', views.CaseStep1Form, name='CaseStep1Form'),
    path('CaseStep2Form/', views.CaseStep2Form, name='CaseStep2Form'),
    path('CaseStep3Form/', views.CaseStep3Form, name='CaseStep3Form'),
